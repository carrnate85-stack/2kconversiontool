CHARACTER MOD TOOL v1.0.142-beta
...
- ZIP hair detection supports both png####_geo_hair*.iff and legacy
  png####_hair*.iff companion naming.
...
- Adds either the bundled stock NBA 2K26 headband or the Fury headband to any
  png character output, fits the selected style to
...
- Uses a flatter stock Fury donor selected for low front-to-back tilt and clean
  forehead surface correspondence.
- Gives only the Fury style a small outward forehead clearance to reduce clipping
  during facial animation; the regular headband fit is unchanged.
...
- Dynamic Body, glasses hihead bake, and headband transfer remain advanced or
