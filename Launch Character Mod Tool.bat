...
if exist "release\CharacterModTool-v1.0.124-beta-PrivateBeta\CharacterModTool.exe" (
    start "" "release\CharacterModTool-v1.0.124-beta-PrivateBeta\CharacterModTool.exe"
    exit /b 0
)
