...
if exist "release\CharacterModTool-v1.0.134-beta-PrivateBeta\CharacterModTool.exe" (
    start "" "release\CharacterModTool-v1.0.134-beta-PrivateBeta\CharacterModTool.exe"
    exit /b 0
)
